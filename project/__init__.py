...
def create_app():
    ...
    with app.app_context():
        ...
        user2 = User(name='admin', email='admin@admin.com', major='Cybersecurity MGT', jobTitle='Security Engineer', company='Example Company', location='Blacksburg, VA', phone='111-111-1111', website='test.com', bio='testing', linkedln='test', twitter='test', public='0', student='0', admin='1', password=generate_password_hash('projectmgt', method='sha256'))
